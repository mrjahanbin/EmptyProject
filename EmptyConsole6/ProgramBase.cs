    ...
    public class ProgramBase
    {
        ...
        public static void ConfigureServices()
        {
            ...
            .AddDbContext<DBContext>(o =>
                o.UseSqlServer("Data Source = .;User Id=sa;Password=123; Initial Catalog = DB6; Integrated Security = false;Trust Server Certificate = true; MultipleActiveResultSets = True"))
